...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary">Assessment List</div>
		<br>
		<div class="card">
			<div class="card-body">
					...
					<tr>
						...
						<td>
							<center>
							 	...
							 	<a class="btn btn-sm btn-outline-primary" href="./answer_sheet.php?id=<?php echo $row['id']?>"><i class="fa fa-pencil"></i> Take Assessment</a>
								<?php else: ?>
