			...
			<div class = "container-fluid">
				<div class = "navbar-header">
					<p class = "navbar-text pull-right text-white"><h3>Assessment System</h3></p>
				</div>
		...
		<div id="sidebar" class="bg-light">
			...
			<div id="sidebar-field">
				<a href="faculty.php" class="sidebar-item text-dark">
						<div class="sidebar-icon"><i class="fa fa-users"> </i></div>  Admin List
				</a>
			</div>
		<?php endif; ?>
			<div id="sidebar-field">
			...
			<div id="sidebar-field">
				<a href="quiz.php" class="sidebar-item text-dark">
						<div class="sidebar-icon"><i class="fa fa-list"> </i></div>  Assessment List
				</a>
			</div>
			<div id="sidebar-field">
				<a href="history.php" class="sidebar-item text-dark">
						<div class="sidebar-icon"><i class="fa fa-history"> </i></div>  Assessment Records
				</a>
			</div>
			<?php else: ?>
			<div id="sidebar-field">
